...
'''
access_key = "0ba2a2e3d0660c470521899a9e023b42"
access_secret = "8w0IbOrZ2eQ7fFjiZEDIwNmV4iMkkBALPT9cg5UV"
...
base_dir = r"E:\Project\audio_clustering\music_recognition"   # change this to your own directory
...
sound = AudioSegment.from_mp3(os.path.join(base_dir, "Tum Se Hi.mp3"))
